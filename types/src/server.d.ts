 ...
 */
export type PickFromPlayers = Pick<Prisma.UsersGroupByOutputType, 'id' | 'name' | 'discord_tag'>
...
export type IronSessionUserData = Pick<Prisma.UsersGroupByOutputType, 'id' | 'name' | 'is_admin' | 'discord_tag'> & { signature: string; };