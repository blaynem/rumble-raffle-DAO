...
const DisplayEntrant = ({ entrant: { id, name }, user }: { entrant: PickFromPlayers; user: Pick<Prisma.UsersGroupByOutputType, 'id' | 'name' | 'is_admin' | 'nonce'> }) => (
...
const Entrants = ({ loading, entrants, user }: { loading?: boolean; entrants: PickFromPlayers[]; user: Pick<Prisma.UsersGroupByOutputType, 'id' | 'name' | 'is_admin' | 'nonce'> }) => {
  return (
